...
struct VertexPosNormal {
    ...
    VertexPosNormal(const VertexPosNormal&) = default;
    VertexPosNormal& operator=(const VertexPosNormal&) = default;
    VertexPosNormal(VertexPosNormal&&) = default;
    VertexPosNormal& operator=(VertexPosNormal&&) = default;
    constexpr VertexPosNormal(const DirectX::XMFLOAT3& _pos, const DirectX::XMFLOAT3& _normal)
...
struct VertexPosColor {
    ...
    constexpr VertexPosColor(const DirectX::XMFLOAT3& _pos, const DirectX::XMFLOAT3& _color)
...
struct VertexPosColorGray {
    VertexPosColorGray() = default;
    VertexPosColorGray(const VertexPosColorGray&) = default;
    VertexPosColorGray& operator=(const VertexPosColorGray&) = default;
    VertexPosColorGray(VertexPosColorGray&&) = default;
    VertexPosColorGray& operator=(VertexPosColorGray&&) = default;
    constexpr VertexPosColorGray(const DirectX::XMFLOAT3& _pos, const uint8_t& _gray)
        : pos(_pos), grayValue(_gray) {}
